        ...
        <div class="col-12 col-lg-10 col-xl-8 col-xxl-7">
          <div id="frontContent">
            <div class="front-content wow fadeIn fadeDelay-04">
              <h1>
                <span class="typewriter-wrap typewriter-wrap--1"><b id="typewriter1">A Thrilling Challenge</b></span>
                Inspired By <span class="typewriter-wrap typewriter-wrap--2"><b id="typewriter2">Super Grandmasters</b></span>
              </h1>
